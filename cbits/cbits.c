/*
  Modified copy of DataStax's Murmur3 hash implementation located at:
  https://github.com/datastax/cpp-driver/blob/63c530087b7fce6e64a551d3a405161277dcc2d3/src/murmur3.cpp
...
static inline int64_t rotl64 (int64_t x, int8_t r) {
...
static FORCE_INLINE int64_t getblock(const int64_t * p, int i) {
        return p[i];
}
...
int64_t _hs_murmur_hash3_x64_128(const void * key, const int len, const uint32_t seed) {
